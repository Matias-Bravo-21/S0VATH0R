...
# linux
interface = 'wlan0mon'
monitor_enable  = 'ifconfig wlan0 down; iw dev wlan0 interface add wlan0mon type monitor; ifconfig wlan0mon down; iw dev wlan0mon set type monitor; ifconfig wlan0mon up'
monitor_disable = 'iw dev wlan0mon del; ifconfig wlan0 up'
change_channel  = 'iw dev wlan0mon set channel %s'
